...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  ...
  sudan: {
    title: 'Sudan Monitor — Real-Time Sudan Intelligence Dashboard',
    description: 'Real-time Sudan-focused intelligence dashboard tracking Sudan conflict events, Country Instability Index (CII), regional Africa news, advisories, and humanitarian signals in one view.',
    keywords: 'Sudan news, Sudan conflict, Sudan civil war, CII Sudan, Sudan intelligence, Sudan risk, Sudan monitoring, Africa dashboard, Sudan alerts, Sudan humanitarian',
    url: 'https://sudan.worldmonitor.app/dashboard',
    siteName: 'Sudan Monitor',
    shortName: 'SudanMonitor',
    subject: 'Sudan Intelligence and Situation Awareness',
    classification: 'Sudan Intelligence Dashboard, Sudan Conflict Tracker, CII',
    categories: ['news', 'productivity'],
    features: [
      'Sudan news aggregation',
      'Country Instability Index for Sudan',
      'Sudan conflict events feed',
